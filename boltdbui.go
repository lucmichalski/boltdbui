//
// boltdbui is a webserver base GUI for interacting with BoltDB databases.
//
package main
...
func init() {
	...
	dbName = os.Getenv("BOLTDBUI_DB_NAME")
	port = os.Getenv("BOLTDBUI_PORT")
